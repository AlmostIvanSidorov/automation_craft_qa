...
class TestAlertsFrameWindow:
    class TestBrowserWindows:
        def test_new_tab(self, driver):
            ...
            assert test_result == 'This is a sample page', 'the new tab has not opened or incorrect tab has been opened'

        def test_new_window(self, driver):
            browser_window_page = BrowserWindowPage(driver, "https://demoqa.com/browser-windows")
            browser_window_page.open()
            test_result = browser_window_page.checked_opened_new_window()
            assert test_result == 'This is a sample page', 'the new window has not opened or incorrect window has been opened'
